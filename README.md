...
| Python | `pip install lovyou-eventgraph` | 157 | `python/` |
| .NET | `dotnet add package LovYou.EventGraph` | 130 | `dotnet/` |
| Rust | `cargo add eventgraph` | 103 | `rust/` |
| TypeScript | `npm install @lovyou-ai/eventgraph` | 150 | `ts/` |
